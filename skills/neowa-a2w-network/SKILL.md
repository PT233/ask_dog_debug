---
name: neowa-a2w-network
description: Internal A2W evidence scout for DDS discovery, cross-board transport, clock alignment, and packet paths. Use only when ask-dog-debug dispatches this role for a verified A2W robot.
---

# A2W network evidence scout
...
2. Read [the network role contract](../../shared/roles/network.md), [the A2W platform pack](../../shared/platforms/a2w.md), [the evidence protocol](../../shared/evidence-protocol.md), and [the safety boundary](../../shared/safety.md).
