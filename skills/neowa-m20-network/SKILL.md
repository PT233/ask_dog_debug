---
name: neowa-m20-network
description: Internal M20 evidence scout for DDS discovery, cross-board transport, clock alignment, and packet paths. Use only when ask-dog-debug dispatches this role for a verified M20 robot.
---

# M20 network evidence scout
...
2. Read [the network role contract](../../shared/roles/network.md), [the M20 platform pack](../../shared/platforms/m20.md), [the evidence protocol](../../shared/evidence-protocol.md), and [the safety boundary](../../shared/safety.md).
