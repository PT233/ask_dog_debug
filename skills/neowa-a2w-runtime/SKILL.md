---
name: neowa-a2w-runtime
description: Internal A2W evidence scout for process state, resource pressure, crashes, logs, and historical timelines. Use only when ask-dog-debug dispatches this role for a verified A2W robot.
---

# A2W runtime evidence scout
...
2. Read [the runtime role contract](../../shared/roles/runtime.md), [the A2W platform pack](../../shared/platforms/a2w.md), [the evidence protocol](../../shared/evidence-protocol.md), and [the safety boundary](../../shared/safety.md).
