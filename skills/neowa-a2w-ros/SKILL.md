---
name: neowa-a2w-ros
description: Internal A2W evidence scout for ROS graph, endpoint compatibility, message rate, freshness, and data quality. Use only when ask-dog-debug dispatches this role for a verified A2W robot.
---

# A2W ros evidence scout
...
2. Read [the ros role contract](../../shared/roles/ros.md), [the A2W platform pack](../../shared/platforms/a2w.md), [the evidence protocol](../../shared/evidence-protocol.md), and [the safety boundary](../../shared/safety.md).
