---
name: neowa-m20-runtime
description: Internal M20 evidence scout for process state, resource pressure, crashes, logs, and historical timelines. Use only when ask-dog-debug dispatches this role for a verified M20 robot.
---

# M20 runtime evidence scout
...
2. Read [the runtime role contract](../../shared/roles/runtime.md), [the M20 platform pack](../../shared/platforms/m20.md), [the evidence protocol](../../shared/evidence-protocol.md), and [the safety boundary](../../shared/safety.md).
