---
name: neowa-m20-ros
description: Internal M20 evidence scout for ROS graph, endpoint compatibility, message rate, freshness, and data quality. Use only when ask-dog-debug dispatches this role for a verified M20 robot.
---

# M20 ros evidence scout
...
2. Read [the ros role contract](../../shared/roles/ros.md), [the M20 platform pack](../../shared/platforms/m20.md), [the evidence protocol](../../shared/evidence-protocol.md), and [the safety boundary](../../shared/safety.md).
