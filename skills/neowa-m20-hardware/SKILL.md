---
name: neowa-m20-hardware
description: Internal M20 evidence scout for device presence, driver entry, process ownership, temperature, and throttling. Use only when ask-dog-debug dispatches this role for a verified M20 robot.
---

# M20 hardware evidence scout
...
2. Read [the hardware role contract](../../shared/roles/hardware.md), [the M20 platform pack](../../shared/platforms/m20.md), [the evidence protocol](../../shared/evidence-protocol.md), and [the safety boundary](../../shared/safety.md).
